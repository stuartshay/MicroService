...
```
dotnet sonarscanner begin /k:"MicroService.Api" /d:sonar.host.url="http://192.168.1.172:9100" /d:sonar.cs.vscoveragexml.reportsPaths=coverage.xml /d:sonar.login="***REMOVED-SONAR-TOKEN***"
