node('buildx')  {
   ...
   stage('Build & Deploy Docker') {
        ...
        docker build -f docker/microservice-api-build.dockerfile/Dockerfile --build-arg BUILD_NUMBER=${BUILD_NUMBER} -t stuartshay/microservice-api:3.1.4-build .'''
        ...
        sh '''docker push stuartshay/microservice-api:3.1.4-build'''
    }
